...
var setCurrentStack = (stack) => currentStack = stack;
...
var nativeFn = (code2, includes2 = [], language = "") => {
  for (let i = 0; i < includes2.length; i++) {
    const include = includes2[i];
    if (typeof include === "function") {
      includes2[i] = include.functionNode;
    }
  }
  const functionNode = nodeObject(new FunctionNode(code2, includes2, language));
...
//# sourceMappingURL=chunk-JWPILFIS.js.map
