...
import { generateInfoPanel } from "../2DElements/InfoPanel";
...
tags.push(new FloatTag2D("上海", shanghaiLoc , ()=>{
    sidebarInstance = generateInfoPanel({    
...
tags.push(new FloatTag2D("北京", beijingLoc , ()=>{
    sidebarInstance = generateInfoPanel({    
...
tags.push(new FloatTag2D("深圳", shenzhenLoc , ()=>{
    sidebarInstance = generateInfoPanel({    
        textContent: '中欧国际工商学院深圳校区地处粤港澳大湾区最核心区域，教学设施一流，环境设计崇尚人与自然的和谐共生。深圳校区为华南地区快速发展的中资企业和跨国公司培养了大批国际化高级经营管理人才。',
        title: '深圳校区',
        buttonName: '点击前往',
...
export default class Earth extends SceneGraph{
    ...
    CreateModels(){
        ...
        // sphere.position.set(shanghaiLoc.x, shanghaiLoc.y, shanghaiLoc.z)
        // sphere.name = 'Ignore'
